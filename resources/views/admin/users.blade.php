...
<div class="space-y-8 animate-in fade-in duration-700" 
    ...
    <div class="relative overflow-hidden bg-stone-900 rounded-xl p-10 shadow-md">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 px-2">
        <div class="relative w-full sm:w-96 group">
            ...
            <input type="text" x-model="searchQuery" placeholder="SEARCH BY USERNAME..." 
                   class="w-full bg-white border border-stone-200 rounded-lg pl-12 pr-4 py-4 text-[10px] font-extrabold uppercase tracking-widest focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary outline-none transition-all shadow-sm">
        </div>
        
        <button @click="showAddUserModal = true" 
                class="w-full sm:w-auto flex items-center justify-center gap-3 bg-brand-primary hover:opacity-90 text-white font-extrabold text-[10px] uppercase tracking-widest py-4 px-8 rounded-lg shadow-md transition-all hover:-translate-y-0.5 active:translate-y-0 outline-none">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <div x-show="!searchQuery || '{{ strtolower($user->username) }}'.includes(searchQuery.toLowerCase())"
             class="group relative bg-white border border-stone-200 rounded-xl p-8 shadow-sm hover:shadow-lg hover:border-brand-primary/30 transition-all duration-300">
            ...
            <div class="absolute top-8 right-8">
                <form action="{{ route('users.toggle', $user->id) }}" method="POST">
                    @csrf @method('PATCH')
                    <button type="submit" 
                            class="flex items-center gap-2 px-3 py-1.5 rounded text-[9px] font-extrabold uppercase tracking-widest border transition-all {{ $user->is_active ? 'bg-emerald-50 text-emerald-600 border-emerald-200' : 'bg-stone-50 text-stone-400 border-stone-200' }}">
            ...
            <div class="flex flex-col items-center text-center space-y-4">
                <div class="relative">
                    <div class="w-24 h-24 bg-stone-50 border border-stone-200 rounded-xl flex items-center justify-center text-stone-400 group-hover:text-brand-primary transition-colors duration-300">
                ...
                <div class="space-y-1">
                    ...
                    <span class="px-3 py-1 bg-brand-light border border-brand-primary/20 text-brand-primary rounded text-[9px] font-extrabold uppercase tracking-widest inline-block">
                        {{ $user->role }}
                    </span>
                </div>
            </div>
            ...
            <div class="mt-8 flex gap-3">
                <button class="flex-1 py-3 bg-stone-50 hover:bg-stone-100 border border-stone-200 text-stone-500 hover:text-brand-primary rounded-lg text-[10px] font-extrabold uppercase tracking-widest transition-all">
                ...
                <form action="{{ route('users.destroy', $user->id) }}" method="POST" class="flex-1" data-confirm="Are you sure you want to delete this user? This action cannot be undone.">
                    @csrf @method('DELETE')
                    <button type="submit" class="w-full py-3 bg-white hover:bg-rose-50 border border-rose-200 text-rose-500 rounded-lg text-[10px] font-extrabold uppercase tracking-widest transition-all">
    ...
    <div x-show="showAddUserModal" 
        ...
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden border border-stone-200"
            ...
            <div class="p-10">
                <div class="flex justify-between items-start mb-10">
                    ...
                    <button @click="showAddUserModal = false" class="p-3 bg-stone-50 text-stone-400 hover:text-stone-600 border border-stone-200 rounded-lg transition-all outline-none">
                ...
                <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="username" required placeholder="E.G. JOHNDOE"
                                   class="w-full bg-stone-50 border border-stone-200 rounded-xl pl-12 pr-6 py-4 text-stone-900 font-extrabold text-[10px] uppercase tracking-widest focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password" required placeholder="••••••••"
                                   class="w-full bg-stone-50 border border-stone-200 rounded-xl pl-12 pr-6 py-4 text-stone-900 font-extrabold text-[10px] tracking-widest focus:ring-2 focus:ring-brand-primary/20 focus:border-brand-primary transition-all outline-none">
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="p-4 rounded-xl bg-stone-50 border border-stone-200 peer-checked:border-brand-primary peer-checked:bg-brand-light transition-all text-center">
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="p-4 rounded-xl bg-stone-50 border border-stone-200 peer-checked:border-rose-500 peer-checked:bg-rose-50 transition-all text-center">
                    ...
                    <div class="pt-6">
                        <button type="submit" 
                                class="w-full py-4 bg-brand-primary hover:opacity-90 text-white rounded-lg text-[10px] font-extrabold uppercase tracking-widest shadow-sm transition-all outline-none">
